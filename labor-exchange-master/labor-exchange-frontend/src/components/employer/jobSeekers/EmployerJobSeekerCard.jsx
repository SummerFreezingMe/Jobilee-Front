...
const EmployerJobSeekerCard = ({ id, jobSeeker, favorites, onLike }) => {
  return (
    <div className="mx-auto mb-6 w-1/2 p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
      <div className="relative mt-3">
        ...
        >
          {favorites && favorites.some(favorite => favorite.job_seeker_id === jobSeeker.id) ? <img className="w-6" src="/like.svg" alt="like" /> : <img className="w-6" src="/dislike.svg" alt="dislike" />}
        </button>
      </div>
...
export default EmployerJobSeekerCard;